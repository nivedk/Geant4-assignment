...
G4int total_hits = 0, total_muons = 0;
...
{  
 ...
 G4int totalCalHit = 0; 
  ...
  G4cout << " Calorimeter has " << totalCalHit << " hits." << total_hits<<G4endl<<" Calorimeter has " << total_muons << " hits." << total_hits<<G4endl;
  total_hits+=totalCalHit; 
//if(step -> GetTrack() -> GetDefinition() == G4MuonMinus::Definition())
//{total_muons+=totalCalHit;}
